        ...
        if (isEditMode) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    await axios.put('http://localhost:8000/api/customer-details', formData ,{
                        headers: {
            ...
            swalWithBootstrapButtons.fire({
                ...
                //     await axios.post('http://localhost:8000/api/customer-details', {
                //     ID_Code: ID_Code,
                //     Tradename: Tradename,
                //     Fname: Fname,
                //     Lname: Lname,
                ...
                formData.append('Remarks', Remarks);
                formData.append('image', imagePreview);
                await axios.post('http://localhost:8000/api/customer-details', formData ,{
                    headers: {
                        'Content-Type': 'multipart/form-data',
                      },
            ...
            if (result.isConfirmed) {
                try {
                    if (ID_Code ===''){
                        ...
                        axios.delete('http://localhost:8000/api/customer-search', {
                        params: {
                          id_code: ID_Code,
                        },
                      })
...
const handleSearch= async (e) => {
    ...
    try {
        if (e ===''){
            ...
            axios.get('http://localhost:8000/api/customer-search', {
            params: {
              trade_name: e,
            },
          })
...
<Fragment>
    <div className="card-container" >
        <div class="card">
            ...
            <div class="card-body" ref={containerRef}>
                <Tabs>
                    <TabList>   
                    {tabVisible && (
                                   ...
                                   <div className='card-body' >
                                        <div className='row'>
                                            ...
                                            <div className='col-md-6'>
                                                ...
                                                <div className='form-group customer' style={{display:'flex',marginBottom:'10px'}}>
                                ...
                                <div class="card-header">
                                    <div className='customer-container'>
                                        ...
                                        {/* {unitLocations.map(unit => (
                                                <tr key={unit.ul_code} onClick={() => handleRowClick(unit)}>
